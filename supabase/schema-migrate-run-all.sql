-- =============================================================================
-- Animédula — EJECUTAR TODO DE UNA VEZ
-- Supabase → SQL Editor → pegar este archivo completo → Run
--
-- Después (manual en el panel, no SQL):
--   • Storage → bucket "captures" (público)
--   • Database → Replication → forum_posts, post_reactions
--   • (Opcional) descomenta admin al final y vuelve a Run solo esa línea
-- =============================================================================
...
create unique index if not exists user_badges_user_badge_key on public.user_badges (user_id, badge_id);
