...
const NAV_ITEMS: { href: string; label: string; short?: string; icon: IconName; match?: (p: string) => boolean }[] = [
  ...
  { href: '/anime', label: NAV.airing, short: 'Emisión', icon: 'anime', match: (p) => p === '/anime' || p.startsWith('/anime/') },
  { href: '/calendario', label: NAV.calendar, short: 'Calendario', icon: 'calendar', match: (p) => p.startsWith('/calendario') },
